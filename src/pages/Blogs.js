        ...
        {selectedEntry && (
          ...
          >
            <div className='map-info-container'>
              ...
              >
                <h2 className='map-info-header'>{selectedEntry.title}</h2>
                <p className='map-info-date'>
                  {moment(selectedEntry.date_visited).format('MMMM Do YYYY')}
                </p>
                <p className='map-info-text'>{selectedEntry.blog_text}</p>
                <div className='map-info-author-container'>
                  ...
                  />
                  <p className='map-info-author'>{selectedEntry.author}</p>
                </div>
              </a>
            </div>
          </InfoWindow>
