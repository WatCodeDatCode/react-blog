    ...
    <>
      <div className='form-page-container'>
        ...
        <div className='contact-image-container'>
          ...
          <div className='image-overlay'>
            <div className='contact-image-text'>
              ...
              <h3 className='mt-1 md:mt-6 image-contact-info'>Address</h3>
              ...
              <h3 className='mt-1 md:mt-6 image-contact-info'>Phone</h3>
              <p className='image-contact-details'>+49 1522 7970969</p>
            </div>
          </div>
        </div>
        <div className='contact-body-container'>
          <div className='mx-4'>
            <p>
              "This blog was bootstrapped with Create-React-App" and done by
              your friendly neighborhood Beardyman, Andrew Russell, as a final
              project for the{' '}
              <a
            ...
            <p className='mt-6'>
              If you have any questions, feedback, or just want to set up an
              appointment to play with my beard, feel free to use the contact
              form below.
            </p>
            <p className='mt-6'>
              Find any bugs or have suggestions for improving this site? Feel
        ...
        {loading || error ? (
          ...
          <div className='form-wrapper'>
            <p className='loader-container success-message'>Message sent!</p>
          </div>
        )}
      </div>
    </>
